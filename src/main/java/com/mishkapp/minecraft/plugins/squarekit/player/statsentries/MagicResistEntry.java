 ...
 */
public class MagicResistEntry extends StatsEntry{
    @Override
    public Text getText(KitPlayer kitPlayer) {
        return _text(Messages.get("stats.magic-resist")
                .replace("%MRES%",
                        FormatUtils.unsignedRound(kitPlayer.getMagicResist() * 100)));
    }

    @Override
    public String getRawDescription() {
        return Messages.get("stats.magic-resist-desc");
    }
}
