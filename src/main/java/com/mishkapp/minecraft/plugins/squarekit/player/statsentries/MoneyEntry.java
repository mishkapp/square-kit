 ...
 */
public class MoneyEntry extends StatsEntry {
    @Override
    public Text getText(KitPlayer kitPlayer) {
        return _text(Messages.get("stats.money")
                .replace("%MONEY%",
                        FormatUtils.unsignedRound(kitPlayer.getMoney())));
    }

    @Override
    public String getRawDescription() {
        return Messages.get("stats.money-desc");
    }
}
