 ...
 */
public class EvasionEntry extends StatsEntry{
    @Override
    public Text getText(KitPlayer kitPlayer) {
        return _text(Messages.get("stats.evasion")
                .replace("%EVASION%",
                        FormatUtils.unsignedRound(kitPlayer.getEvasion() * 100)));
    }

    @Override
    public String getRawDescription() {
        return Messages.get("stats.evasion-desc");
    }
}
