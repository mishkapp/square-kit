...
public abstract class HoldingEffectSuffix extends Suffix {
    ...
    public HoldingEffectSuffix(KitPlayer kitPlayer, ItemStack itemStack, String[] args, PotionEffectType potionEffectType) {
    ...
    public String getLoreEntry() {
        return Messages.get("suffix.holding-effect")
