 ...
 */
public class KdRatioEntry extends StatsEntry {
    @Override
    public Text getText(KitPlayer kitPlayer) {
        return _text(Messages.get("stats.kdr")
                .replace("%KDR%",
                        FormatUtils.unsignedTenth(kitPlayer.getKdRatio() * 100)));
    }

    @Override
    public String getRawDescription() {
        return Messages.get("stats.kdr-desc");
    }
}
